...
Report `pendingRequests`, `pendingQuestionCount` and `pendingApprovalCount` when present. Use the inbox skill for targeted detail; pending questions are not automatically safe to answer.
